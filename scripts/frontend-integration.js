 ...
 * This file demonstrates how to integrate Surgeiris with a web frontend
 */

// For React/Vue/Angular applications
export class SurgeirisClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new SurgeirisClient(provider, contractAddress);
